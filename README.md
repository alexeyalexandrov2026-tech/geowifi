...
|---------------------------------------|-------------------------------------|-------------------------------------------------------------------------------------|-------------------------------------------------------|
| **[WifiDB](https://www.wifidb.net/)** | **[Combain](https://combain.com/)** | **[Freifunk Carte](https://www.freifunk-karte.de/)**                                | **вќЊ (Discontinued) [OpenWifi](https://openwifi.su/)** |
...
## рџ”‘ APIs and configuration file
...
### рџ—єпёЏ Map output example

![Map output](https://imgur.com/CilV4LR.png)

### рџ’ѕ Json output example
